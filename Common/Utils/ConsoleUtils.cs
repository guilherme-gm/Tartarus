...
namespace Common.Utils
{
    ...
    public static class ConsoleUtils
    {
        ...
        public static void ShowHeader(string windowTitle)
        {
            ...
            newMessage.BackColor = ConsoleColor.Green;
            newMessage.ForeColor = ConsoleColor.White;
        ...
        /// <summary>
        /// Writes a ConsoleMessage to the console.
        /// This class is used to really put text into console
        /// </summary>
        ...
        private static void WriteMessage(ConsoleMessage message)
        {
            ...
            if (message.TextBlocks.Length > 0)
            {
                ...
                Console.Write(assembledText);
                Console.ResetColor();
            }
        }

        /// <summary>
        /// Writes a list of messages to console.
        /// </summary>
        /// <param name="mes">messages</param>
        private static void WriteMessage(List<ConsoleMessage> mes)
        {
            foreach (ConsoleMessage msg in mes)
            {
                WriteMessage(msg);
            }
        }
        ...
        public static void Write(MsgType type, string text, params object[] replacers)
        {
            ...
            lock (WriteLock)
            {
                ...
                {
                    case MsgType.Status:
                        mes.Add(new ConsoleMessage { TextBlocks = new string[] { "[Status] " }, ForeColor = ConsoleColor.Green });
                        break;

                    case MsgType.SQL:
                        mes.Add(new ConsoleMessage { TextBlocks = new string[] { "[SQL] " }, ForeColor = ConsoleColor.Magenta });
                        break;

                    case MsgType.Info:
                        mes.Add(new ConsoleMessage { TextBlocks = new string[] { "[Info] " }, ForeColor = ConsoleColor.Gray });
                        break;

                    case MsgType.Notice:
                        mes.Add(new ConsoleMessage { TextBlocks = new string[] { "[Notice] " }, ForeColor = ConsoleColor.Gray });
                        break;

                    case MsgType.Warning:
                        mes.Add(new ConsoleMessage { TextBlocks = new string[] { "[Warning] " }, ForeColor = ConsoleColor.Yellow });
                        break;

                    case MsgType.Debug:
                        mes.Add(new ConsoleMessage { TextBlocks = new string[] { "[Debug] " }, ForeColor = ConsoleColor.Cyan });
                        break;

                    case MsgType.Error:
                        mes.Add(new ConsoleMessage { TextBlocks = new string[] { "[Error] " }, ForeColor = ConsoleColor.Red });
                        break;

                    case MsgType.FatalError:
                        mes.Add(new ConsoleMessage { TextBlocks = new string[] { "[Fatal Error] " }, ForeColor = ConsoleColor.Red });
                        break;
                ...
                mes.Add(new ConsoleMessage { TextBlocks = new string[] { string.Format(text, replacers) }, ForeColor = ConsoleColor.White, InsertNewLine = true });
                WriteMessage(mes);
            }
        }
